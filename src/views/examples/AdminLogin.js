            ...
            <Col lg="5" md="7">
              <div className="admin-login-card">
                <Card className="shadow-lg border-0">
                  {/* Admin Header */}
                  <div className="admin-header bg-gradient-danger py-5 text-center">
                    <div className="mb-3">
                  ...
                  <CardBody className="px-lg-5 py-lg-5">
                    ...
                    {/* Security Notice */}
                    <div
                      className="alert alert-info border-0 py-3 text-center"
                      role="alert"
                      style={{ fontSize: "12px", backgroundColor: "#f0f3ff" }}
                    >
