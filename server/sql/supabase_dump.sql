...
\restrict 95AZsVWVkhSpHoQifRnOLTIke4uZ3MM1JhZHNnq03zN5lSkhcz8bqGvuMdO4Tr9
...
--
-- Name: objects Allow authenticated uploads 1ef46i8_0; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow authenticated uploads 1ef46i8_0" ON storage.objects FOR INSERT TO authenticated, anon WITH CHECK ((bucket_id = 'quiz-images'::text));


--
-- Name: objects Authenticated users can upload quiz images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Authenticated users can upload quiz images" ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'quiz-images'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Public read access 1ef46i8_0; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Public read access 1ef46i8_0" ON storage.objects FOR SELECT USING ((bucket_id = 'quiz-images'::text));


--
-- Name: objects Public read access for quiz-images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Public read access for quiz-images" ON storage.objects FOR SELECT USING ((bucket_id = 'quiz-images'::text));
...
\unrestrict 95AZsVWVkhSpHoQifRnOLTIke4uZ3MM1JhZHNnq03zN5lSkhcz8bqGvuMdO4Tr9
